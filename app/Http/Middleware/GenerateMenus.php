    ...
    public function handle($request, Closure $next)
    {
        ...
        */
        ...
        \Menu::make('admin_sidebar', function ($menu) {
            ...
            //Property Type
            $menu->add('<i class="c-sidebar-nav-icon fas fa-book-open"></i> ' . trans('Property Type'), [
                'route' => 'backend.properties.index',
                'class' => 'c-sidebar-nav-item',
            ])
                ->data([
                    'order'         => 2,
                    'activematches' => 'admin/properties*',
            ...
            //Properties
            $menu->add('<i class="c-sidebar-nav-icon fas fa-clone"></i> ' . trans('Properties'), [
                ...
                ->data([
                    ...
                    'permission'    => ['edit_sliders'],
                ])
                ->link->attr([
                    'class' => 'c-sidebar-nav-link',
                ]);
            //Notices
            $menu->add('<i class="c-sidebar-nav-icon fas fa-sticky-note"></i> ' . trans('Notices'), [
            ...
            //Contact Us
            $menu->add('<i class="c-sidebar-nav-icon fas fa-id-card-alt"></i> ' . trans('Contact Us'), [
            ...
            //About Us  
            $menu->add('<i class="c-sidebar-nav-icon fas fa-info"></i> ' . trans('About Us'), [
                'route' => 'backend.abouts.index',
                'class' => 'c-sidebar-nav-item',
            ])
                ->data([
                    'order'         => 7,
                    'activematches' => 'admin/abouts*',
                    'permission'    => ['edit_abouts'],
                ])
                ->link->attr([
                    'class' => 'c-sidebar-nav-link',
                ]);
            ...
            // company fa-cogs
            $menu->add('<i class="c-sidebar-nav-icon fas fa-building"></i> ' . trans('Company Details'), [
