...
<div class="card">
    <div class="card-body">
       ...
       <ul class="list-group list-group-flush">
            <li class="list-group-item">Property Type:&nbsp {{$property->property_type}}</li>
            <li class="list-group-item">Accomodation Status:&nbsp {{$property->accomodation_status}}</li>
          </ul>
        <hr>
        <div class="row">
