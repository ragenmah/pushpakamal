    ...
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <form action="{{route('backend.pricings.update',$pricing->id)}}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="listing_type" class="form-control"  value="{{$pricing->listing_type}}}" > 
                        </div>
                        <div class="col-md-6">
                            @error('listing_type')
                   ...
                   <label for="price">Price<span class="text-danger">( * ) </span></label>
                    ...
                    <div class="form-group">
                       ...
                       <label for="title_color">Choose Title Color<span class="text-danger">( * ) </span></label>
                        <input type="color" name="title_color"  value="{{$pricing->title_color}}" > 
                        </div>
                        <div class="col-md-6">
                            @error('title_color')
                            <div class="alert alert-danger">
                    ...
                    <div class="form-group">
                       ...
                       <label for="image_details">Image Details<span class="text-danger">( * ) </span> </label>
                        <input type="text" name="image_details" class="form-control"  value="{{$pricing->image_details}}" > 
                        </div>
                        <div class="col-md-6">
                            @error('image_details')
                            <div class="alert alert-danger">
                            ...
                            <div class="form-group">
                               ...
                               <label for="property_details">Property Details<span class="text-danger">( * ) </span></label>
                                <input type="text" name="property_details" class="form-control" value="{{$pricing->property_details}}" > 
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="form-group">
                       ...
                       <label for="time_span">Time Span <span class="text-danger">( * ) </span></label>
                        <input type="text" name="time_span" class="form-control"  value="{{$pricing->time_span}}" > 
                        </div>
                        <div class="col-md-6">
                            @error('time_span')
                            <div class="alert alert-danger">
                  ...
                  <div class="col-8">
                        <div class="float-right">
                            ...
                            <a href="{{ route("backend.$module_name.destroy",$pricing->id) }}" class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.delete')}}"><i class="fas fa-trash-alt"></i></a>
                            @endcan
