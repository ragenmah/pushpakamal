<header class="header-global">
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg headroom py-lg-3 px-lg-6 navbar-dark bg-puspha">
        <div class="container">
            <div>
                <a class="navbar-brand" href="/">
                    <img class="main-logo navbar-brand-dark common " src="{{asset('img/logonew.png')}}" >
                </a>
            </div>
                ...
                <div class="navbar-collapse-header">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="/">
                                <img src="{{ asset('img/logonew.png') }}" class="main-logo" alt="Logo Impact">
                            </a>
                        </div>
                ...
                <ul class="navbar-nav navbar-nav-hover justify-content-center">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('frontend.posts.index') }}" class="nav-link">
                            <i class="fas fa-money-bill-alt"></i> Pricing
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('frontend.abouts') }}" class="nav-link">

                            <span class="fas fa-file-alt mr-1"></span> About Us
                        </a>
                    </li>
                        ...
                        <ul class="dropdown-menu" id="pages_submenu">
                            <li>
                                <a class="dropdown-item" href="{{ route('frontend.posts.index') }}">
                                    <span class="fas fa-file-alt mr-1"></span> Price
                                </a>
                            </li>
