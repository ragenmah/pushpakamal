...
<div class="main-content">
    ...
    <div class="header bg-puspha py-7 py-lg-8">
        <div class="container">
                            ...
                            <div class="row my-4">
                                <div class="col-12">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        <input class="custom-control-input text-success" id="customCheckRegister" type="checkbox">
                                        <label class="custom-control-label" for="customCheckRegister">
                                            <span class="text-muted">I agree with the <a href="#!" class="text-success">Privacy Policy</a></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
