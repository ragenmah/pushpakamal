    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'name'  => 'comp_name', // unique name for field
                'label' => 'Company Name', // you know what label it is
            ...
            [
                ...
                'label' => 'Mobile number', // you know what label it is
                'rules' => 'required|min:10|max:15', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '', // default value if you want
            ],
            // [
